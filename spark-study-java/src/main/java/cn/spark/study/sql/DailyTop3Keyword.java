...
public class DailyTop3Keyword {
  public static void main(String[] args) {
    ...
    JavaPairRDD<String, String> dateKeywordUserRDD = filterRDD
    ...
    JavaPairRDD<String, Long> dateKeywordUvRDD = dateKeywordUsersRDD
    ...
    JavaRDD<Row> dateKeywordUvRowRDD = dateKeywordUvRDD
    ...
    JavaPairRDD<String, String> top3DateKeywordUvRDD = dailyTop3KeywordRDD
    ...
    JavaPairRDD<Long, String> uvDateKeywordsRDD = top3DateKeywordsRDD
        .mapToPair(new PairFunction<Tuple2<String, Iterable<String>>, Long, String>() {

          private static final long serialVersionUID = 1L;

          public Tuple2<Long, String> call(Tuple2<String, Iterable<String>> tuple)
              throws Exception {
